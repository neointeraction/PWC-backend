...
Last updated: 2026-09-16 (`POST /api/v1/projects/wizard` no longer rolls back the whole
call on one bad student row or one booked counsellor slot — see its entry below).
