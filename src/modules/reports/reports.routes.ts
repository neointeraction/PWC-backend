...
// staff see any, and the backend's own headless report-PDF render can too (via a
// report-pdf token instead of a login — see reportPdfAuth.ts). 404 until the student has
// a computed assessment result.
reportsRouter.get(
